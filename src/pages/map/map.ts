...
export class MapPage implements OnInit {
  ...
  async setCurrentCoordinates() {
    try {
      ...
      throw 'Ett fel uppstod när din nuvarande plats skulle hämtas.';
    }
  }
